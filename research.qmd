...
- [Network-Based Decision Support for Cold-Start User Valuation in P2P Platforms](publications.qmd#network-based-decision-support-for-cold-start-user-valuation-in-p2p-platforms-the-role-of-initial-community-structure)
...
- [Modeling the Diffusion Dynamics of Crypto Tokens: A Dual-Process Approach to Adoption and Usage](publications.qmd#modeling-the-diffusion-dynamics-of-crypto-tokens-a-dual-process-approach-to-adoption-and-usage)
